...
const LanguageSelector = () => (
  <div className="relative">
    <button className="flex items-center gap-1 rounded-full border-2 border-slate-200 bg-white/90 px-3 py-2 text-sm text-slate-700 shadow-lg transition-all duration-300 hover:border-blue-300 hover:shadow-xl hover:scale-105 dark:border-slate-700 dark:bg-slate-800/90 dark:text-slate-200 dark:hover:border-cyan-400">
...
const useTranslation = () => ({
  content: { cv: { fullName: 'Stanley Pratama Teguh' } },
  isTranslating: false,
});
                ...
                >
                  <div className="text-center space-y-4">
                    ...
                    <div className="flex items-center justify-center gap-4">
                      ...
                      <a href='https://www.linkedin.com/in/stanley-pratama-teguh/' target='blank'><button className="flex items-center justify-center h-10 w-10 rounded-full bg-slate-100 dark:bg-slate-700 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-all duration-300 hover:scale-110 active:scale-95" >
                      ...
                      <a href='https://github.com/LukasMystic' target='blank'><button className="flex items-center justify-center h-10 w-10 rounded-full bg-slate-100 dark:bg-slate-700 hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-all duration-300 hover:scale-110 active:scale-95">
                        <svg className="h-5 w-5 text-slate-600 dark:text-slate-300" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      © 2024 Stanley Pratama Teguh. All rights reserved.
                    </p>
                  </div>
                </div>
              </div>
