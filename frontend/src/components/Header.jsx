                  ...
                  >
                    <div className="text-center space-y-4">
                      ...
                      <div className="flex items-center justify-center gap-4">
                        ...
                        <a href='https://www.linkedin.com/in/stanley-pratama-teguh/' target='_blank' rel="noopener noreferrer"><button className="flex items-center justify-center h-10 w-10 rounded-full bg-slate-100 dark:bg-slate-700 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-all duration-300 hover:scale-110 active:scale-95" >
                        ...
                        <a href='https://github.com/LukasMystic' target='_blank' rel="noopener noreferrer"><button className="flex items-center justify-center h-10 w-10 rounded-full bg-slate-100 dark:bg-slate-700 hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-all duration-300 hover:scale-110 active:scale-95">
                          <svg className="h-5 w-5 text-slate-600 dark:text-slate-300" fill="currentColor" viewBox="0 0 24 24">
