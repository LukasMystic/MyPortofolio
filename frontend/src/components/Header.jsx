                  ...
                  >
                    <div className="text-center space-y-4">
                      ...
                      <div className="flex items-center justify-center gap-4">
                        ...
                        <a href='https://linkedin.com/in/stanley-pratama-teguh/' target='_blank' rel="noopener noreferrer"><button className="flex items-center justify-center h-10 w-10 rounded-full bg-slate-100 dark:bg-slate-700 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-all duration-300 hover:scale-110 active:scale-95" >
